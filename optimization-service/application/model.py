...
@app.get("/optimize")
def optimize():
    file_path = 'employee_data.csv'  # Ensure the CSV file is in the FastAPI directory
        ...
        assignments = [
            {
                ...
                "role": role,
                "department": dept,
                "floor": office.split('_')[0].replace('Office', '')  # Assuming floor information is encoded in office name
            }
